...
* **Volume (Amount):** Netflix handles the **5PB of daily log data** generated by 200m+ users tracking every click and hover.
...
* **Variety (Type):** * **Structured:** User account and billing details (SQL).
